...
// vBulletin 2.3 Integration for Netfirms Picture Pro
...
define('VB_BD_HOST', 'igotthebeat.netfirmsmysql.com'); // The name of the database server
...
function udb_synchronize_groups()
{
    ...
    // Scan vBulletin Board groups that need to be created inside Netfirms Picture Pro table
...
if (!UDB_CAN_JOIN_TABLES) {
    ...
    if (!$UDB_DB_LINK_ID) die("<b>Netfirms Picture Pro critical error</b>:<br />Unable to connect to vBulletin Board database !<br /><br />MySQL said: <b>" . mysql_error() . "</b>");
}
