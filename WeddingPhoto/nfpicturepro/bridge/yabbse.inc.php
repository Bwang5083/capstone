...
// ------------------------------------------------------------------------- //
// YaBB SE 1.5.4 Integration for Netfirms Picture Pro
...
function udb_synchronize_groups()
{
    ...
    // Scan Board groups that need to be created inside Netfirms Picture Pro table
...
if (!UDB_CAN_JOIN_TABLES) {
    ...
    if (!$UDB_DB_LINK_ID) die("<b>Netfirms Picture Pro critical error</b>:<br />Unable to connect to YaBB SE Board database !<br /><br />MySQL said: <b>" . mysql_error() . "</b>");
}
