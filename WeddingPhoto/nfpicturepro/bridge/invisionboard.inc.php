<?php
// ------------------------------------------------------------------------- //
// Netfirms Picture Pro Photo Gallery 1.2.1                                            //
// ------------------------------------------------------------------------- //
// Copyright (C) 2002,2003 Gregory DEMAR                                     //
// http://www.chezgreg.net/coppermine/                                       //
// ------------------------------------------------------------------------- //
// Updated by the Netfirms Picture Pro Dev Team                                        //
...
// Invision Power Board v1.1 Integration for Netfirms Picture Pro
...
define('IB_BD_HOST', 'igotthebeat.netfirmsmysql.com'); // The name of the database server
...
function udb_synchronize_groups()
{
    ...
    mysql_free_result($result);
    // Scan Netfirms Picture Pro groups that need to be deleted
    ...
    // Scan Invision Board groups that need to be created inside Netfirms Picture Pro table
...
if (!UDB_CAN_JOIN_TABLES) {
    ...
    if (!$UDB_DB_LINK_ID) die("<b>Netfirms Picture Pro critical error</b>:<br />Unable to connect to Invision Board database !<br /><br />MySQL said: <b>" . mysql_error() . "</b>");
}
